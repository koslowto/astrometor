...
def render_graph(ax, e, w, i , o):
    ...
    # Pfeil zum Frühlingspunkt der Erde
    obj.draw_3d_arrow(ax, start=(0, 0, 0), direction=(2, 0, 0), length=2, color='grey')
        
    # Linie zwischen Sonne und Mitte der Ellipse
    ...
    # Linie zwischen Sonne und Periapsis
    ax.plot([0, orbit[0][0]], [0, orbit[1][0]], [0, orbit[2][0]], color='black')

    # Linie zwischen Sonne und Apoapsis
...
def preview_graph(updated_val, ax, prev_int, e, w, i , o):
    ...
    # Graphen nur zeichnen, wenn sich der Winkel um mindestens 10° verändert hat
